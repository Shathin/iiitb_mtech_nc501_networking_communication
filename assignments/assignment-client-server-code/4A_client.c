/*
    SUBNET GAME : Write code for sending data to server and receiving data from it. The data sent will be two IP addresses and a subnet mask.
*/
...
void tcp_connection(); // Handles the connection to the server over TCP
void udp_connection(); // Handles the connection to the server over UDP
